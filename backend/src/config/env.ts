...
const rawEnvSchema = z.object({
  ...
  AMAZON_SP_API_CLIENT_ID: envValue(z.string().min(1).optional()),
  AMAZON_SP_API_CLIENT_SECRET: envValue(z.string().min(1).optional()),
  AMAZON_SP_API_REFRESH_TOKEN: envValue(z.string().min(1).optional()),
  AMAZON_SP_API_MARKETPLACE_ID: envValue(z.string().min(1).default('A1PA6795UKMFR9')),
  AMAZON_SP_API_ENDPOINT: envValue(z.string().url().default('https://sellingpartnerapi-eu.amazon.com')),
