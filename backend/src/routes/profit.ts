...
const profitRequestSchema = z.object({
  ...
  ebayFinalValueFeeThreshold: z.number().min(0).optional(),
  ebayFinalValueFeeBelowThresholdRate: z.number().min(0).optional(),
  ebayFinalValueFeeAboveThresholdRate: z.number().min(0).optional(),
  ...
  taxableSourceShipping: z.boolean().optional(),
  sourcePriceIncludesVat: z.boolean().optional(),
  reclaimInputVat: z.boolean().optional(),
  collectOutputVat: z.boolean().optional(),
  outputVatIncludedInSalePrice: z.boolean().optional(),
  vatModeKey: z.string().min(1).optional(),
  feeRateCardVersion: z.string().min(1).optional(),
  marketplaceKey: z.string().min(1).optional(),
  destinationMarketplaceId: z.string().min(1).optional(),
